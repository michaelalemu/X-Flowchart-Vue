        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: {
                path:
                  "M10,0 L-10,10 L-10.707,9.293 L8.568,0 L-10.707,-9.293 L-10,-10 Z",
                d: 10
              },
              enable: true,
              disabled: false,
    ...
    "editor/log/update": (state, data) => {
      ...
      switch (data.action) {
        ...
        case "record":
          ...
          log.list = [...oldLog.list, JSON.parse(JSON.stringify(data.data))];
          log.current = log.list.length - 1;
          break;
        // 撤销
        case "undo":
          log.list = [...oldLog.list];
        ...
        case "redo":
          ...
          if (oldLog.current === null) {
            ...
            log.current =
              oldLog.current + 1 > oldLog.list.length - 1
                ? oldLog.list.length - 1
                : oldLog.current + 1;
          }
          break;
        // 清空
        case "clearLog":
          log.list = [oldLog.list[oldLog.current]];
          log.current = 0;
          break;
        case "loadData":
          if (oldLog.current === null) {
            log.list = [JSON.parse(JSON.stringify(data.data))];
          } else {
